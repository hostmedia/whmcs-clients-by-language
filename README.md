...
This report shows the distribution of clients by their selected language preference.

## Features
- Analysis % of languges used by clients
...
- You will now see 'Clients by Language' under the 'Other' section
